...
class Vaani:
    ...
    interests = ["AI", "Data", "Automation", "Software"]

    currently = "Data Automation Intern"
...
I'm a **B.Tech CSE student at Graphic Era University**, exploring the space where **software, data and AI** meet.

I like working on problems where the input is messy, the solution isn't obvious, and there's something interesting to build.

Currently, I'm working with **data automation and web data extraction** in the e-commerce domain.
...
**Data Automation Intern — KicksMachine**
`June 2026 — Present`

Working on **data automation, web data extraction and data workflows** in the retail / e-commerce space.

**IEEE Student Branch — Graphic Era University**
`August 2023 — Present`

Part of the organizing team, working across **technical events, coordination, content and team management**.
